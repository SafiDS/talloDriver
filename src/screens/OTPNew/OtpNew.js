...
export default function OtpNew({ navigation }) {
    ...
    return (
      ...
      <Text style = {{alignSelf:'center' , marginTop:50}}>Enter OTP Sent to +{mobile}(30 secs)</Text>
            ...
            <Text style = {{alignSelf:'center' ,fontWeight:'bold', marginTop:30 ,marginBottom:30}} onPress={resendOtp.bind(this)}>Resend OTP</Text>
