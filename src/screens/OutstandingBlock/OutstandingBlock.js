...
export default function OutstandingBlock({ navigation }) {
    ...
    return (
        ...
        <View style={{ marginBottom: 0, padding: 70, margin: 1 }}>
         <View style={{ marginLeft: 15, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
             ...
             <Text style={{ color: 'gray', fontWeight: 'bold', fontSize: 13, marginBottom: 0, alignItems: 'center', justifyContent: 'center', }}>for next 3 days. Due to outstanding</Text>

             <Text style={{ color: 'gray', fontWeight: 'bold', fontSize: 13, marginBottom: 0, alignItems: 'center', justifyContent: 'center', }}>amount not pay to company</Text>

             <TouchableOpacity style={styles.loginBtn}
             >
                 <Text style={styles.buttontext}>Continue to pay $470.00</Text>
             </TouchableOpacity>
         </View>
