...
export default function RiderStatusOnline({route, navigation}) {
    ...
    const getOneTimeLocation = () => {
        ...
        Geolocation.getCurrentPosition(
            (position) => {
                console.log(position,"position of location")
    ...
    async function offlineClicked() {
        ...
        //   navigate('Dashboard');
        fetch("https://www.tallo.in/was/rider_location_update", {
            method: "POST",
            headers: {
    ...
    async function selectGender(image) {
        ...
        // }
        setModalVisible(!modalVisible);
        fetch("https://www.tallo.in/was/rider_login_image_update", {
            method: "POST",
            headers: {
                Accept: "application/json",
                "Content-Type": "application/json",
        ...
        <View style={styles.container}>
            ...
            >
                ...
                >
                    ...
                    <TouchableOpacity onPress={Ridergoinghome}>
                        <Image
                            ...
                            source={require("../../assets/Images/GoTo1.png")}
                        />
                    </TouchableOpacity>
                </View>
                ...
                >
                    ...
                    >
                        {lang.you_are_now_online[LangId]}
                    </Text>
                    ...
                    >
                        {lang.You_need_to_take_photo_and_upload_to[LangId]}
                    </Text>
                    <Text
                        style={{
                            fontSize: 13,
                    ...
                    >
                        {lang.our_tallo_team_for_the_verification[LangId]}
                    </Text>
            ...
            >
                ...
                >
                    <View>
                        ...
                        <Card.Content
                            style={{flexDirection: "row", marginLeft: 1, marginBottom: 20}}
                        >
                            {image != "" ? (
                                <Image
                    ...
                    >
                        ...
                        <View style={{flexDirection: "column", padding: 1}}>
                            ...
                            >
                                {lang.earnings[LangId]}
                            </Text>
                            <Text
                                style={{fontFamily: themes.fontFamily.Bold, fontSize: 15}}
                            >
                                ₹5,470.00
                            </Text>
                        </View>
